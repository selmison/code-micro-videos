...
// Source: github.com/selmison/code-micro-videos/pkg/cast_member (interfaces: Repository)
...
import (
	...
	cast_member "github.com/selmison/code-micro-videos/pkg/cast_member"
	reflect "reflect"
)
...
func (m *MockRepository) GetAll(arg0 context.Context) ([]cast_member.CastMember, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", arg0)
	ret0, _ := ret[0].([]cast_member.CastMember)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) GetMany(arg0 context.Context, arg1 []string) ([]cast_member.CastMember, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetOne(arg0 context.Context, arg1 string) (cast_member.CastMember, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Store(arg0 context.Context, arg1 cast_member.CastMember) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) UpdateOne(arg0 context.Context, arg1 string, arg2 cast_member.UpdateCastMemberDTO) error {
	m.ctrl.T.Helper()
