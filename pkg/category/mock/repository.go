...
// Source: github.com/selmison/code-micro-videos/pkg/category (interfaces: Repository)
...
import (
	...
	category "github.com/selmison/code-micro-videos/pkg/category"
	reflect "reflect"
)
...
func (m *MockRepository) GetAll(arg0 context.Context) ([]category.Category, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetMany(arg0 context.Context, arg1 []string) ([]category.Category, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetOne(arg0 context.Context, arg1 string) (category.Category, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Store(arg0 context.Context, arg1 category.Category) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) UpdateOne(arg0 context.Context, arg1 string, arg2 category.UpdateCategory) error {
	m.ctrl.T.Helper()
