...
// Source: github.com/selmison/code-micro-videos/pkg/video (interfaces: Repository)
...
import (
	...
	video "github.com/selmison/code-micro-videos/pkg/video"
	reflect "reflect"
)
...
func (m *MockRepository) GetAll(arg0 context.Context) ([]video.Video, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", arg0)
	ret0, _ := ret[0].([]video.Video)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) GetMany(arg0 context.Context, arg1 []string) ([]video.Video, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetOne(arg0 context.Context, arg1 string) (video.Video, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Store(arg0 context.Context, arg1 video.Video) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) UpdateOne(arg0 context.Context, arg1 string, arg2 video.UpdateVideo) error {
	m.ctrl.T.Helper()
