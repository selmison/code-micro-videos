...
func (m loggingMiddleware) Create(ctx context.Context, newVideo NewVideo) (output Video, err error) {
	defer func() {
		m.log("Create", newVideo, output, err)
	}()
...
func (m loggingMiddleware) List(ctx context.Context) (output []Video, err error) {
	defer func() {
...
func (m loggingMiddleware) Show(ctx context.Context, id string) (output Video, err error) {
	defer func() {
...
func (m loggingMiddleware) Update(ctx context.Context, id string, updateVideo UpdateVideo) (err error) {
	defer func() {
		m.log(
			"Show",
